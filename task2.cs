// Dafny program task2.dfy compiled into C#
...
// Command-line arguments: run --no-verify task2.dfy
// task2.dfy
...
method FindFirstNegative(a: array<int>) returns (index: int)
  ...
  ensures index < a.Length ==> forall k: int {:trigger a[k]} :: 0 <= k < index ==> a[k] >= 0
  ensures index == a.Length ==> forall k: int {:trigger a[k]} :: 0 <= k < a.Length ==> a[k] >= 0
  decreases a
{
  var i := 0;
  while i < a.Length
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger FindFirstNegative(BigInteger[] a)
    {
