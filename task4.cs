// Dafny program task4.dfy compiled into C#
...
// Command-line arguments: run task4.dfy
// task4.dfy
  ...
  public partial class __default {
    public static BigInteger Trib(BigInteger n) {
      if ((n).Sign == 0) {
        ...
        return ((__default.Trib((n) - (BigInteger.One))) + (__default.Trib((n) - (new BigInteger(2))))) + (__default.Trib((n) - (new BigInteger(3))));
      }
    }
    public static BigInteger ComputeTrib(BigInteger n)
    {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_t0;
      BigInteger _out0;
      _out0 = __default.ComputeTrib(BigInteger.Zero);
      _0_t0 = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("T(0) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_t0));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _1_t3;
      BigInteger _out1;
      _out1 = __default.ComputeTrib(new BigInteger(3));
      _1_t3 = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("T(3) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_t3));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _2_t4;
      BigInteger _out2;
      _out2 = __default.ComputeTrib(new BigInteger(4));
      _2_t4 = _out2;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("T(4) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_t4));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
