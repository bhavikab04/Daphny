// Dafny program task1.dfy compiled into C#
...
// Command-line arguments: run task1.dfy
// task1.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _out0;
      _out0 = __default.Abs(new BigInteger(10));
      _0_result1 = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Abs(10) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_result1));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _1_result2;
      BigInteger _out1;
      _out1 = __default.Abs(new BigInteger(-5));
      _1_result2 = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Abs(-5) = ")).ToVerbatimString(false));
      ...
      _2_result3 = _out2;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Abs(0) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_result3));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("All absolute value tests passed and the method was verified by Dafny.\n")).ToVerbatimString(false));
    }
  }
